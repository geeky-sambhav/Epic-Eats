...
layout = [    
    [sg.Text('CANTEEN ADMIN PANEL', text_color="yellow",justification="5")],
    [sg.Text("Product\t\tQuantity \tNew Quantity\t\tPrice\t\tNew Price")]
]
for x in lst:
    layout.append(x)
layout.append([sg.Button('UPDATE STOCK')])
layout.append([sg.Text(key='-update-', text_color="yellow")])
layout.append([sg.Text('Add/Remove Products', text_color="yellow")])
